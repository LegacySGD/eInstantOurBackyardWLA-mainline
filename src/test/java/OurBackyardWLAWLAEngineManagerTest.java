...
public class OurBackyardWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(OurBackyardWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/OurBackyardWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/OurBackyardWLAIW/InitOutcome.xml").getDocumentElement();
